        ...
        <div class="col product_section clearfix">
            ...
            <div class="breadcrumbs d-flex flex-row align-items-center">
                <ul>
                    ...
                    <li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>{{ $this_cate->title }}</a></li>
                </ul>
            </div>
            ...
            <div class="sidebar">
                <div class="sidebar_section">
                    ...
                    <ul class="sidebar_categories">
                        ...
                        {{-- {{ str_contains(request()->url(), "/{{ $item->title }}") ? '<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>' : ''}} --}}
                            <li class="{{ str_contains(request()->url(), $slug ) ? 'active' : '' }}" ><a href="/shop/category/{{ $slug }}/{{ $item->id }}"><span><i class="{{ str_contains(request()->url(), $slug ) ? 'fa fa-angle-double-right' : '' }}" aria-hidden="true"></i></span>{{ $item->title }}</a></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="sidebar_section">
                    ...
                    <div class="filter_button" data-id="{{ $this_cate->id }}"><span>filter</span></div>
                </div>
                                ...
                                <ul class="product_sorting">
                                    <li>
                                        ...
                                        <ul class="sorting_type">
                                            ...
                                            <li class="type_sorting_btn_desc" data-isotope-option='{ "sortBy": "price" }'><span>Price</span></li>
                                        </ul>
                                    </li>
                                </ul>
